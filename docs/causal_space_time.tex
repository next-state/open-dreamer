...
\node[action] (linear-am1) {$a_{t-1}$};
\node[state, right=7mm of linear-am1] (linear-st) {$s_t$};
\node[agent, right=7mm of linear-st] (linear-pit) {$\pi_t$};
\node[action, right=7mm of linear-pit] (linear-at) {$a_t$};
\node[state, right=7mm of linear-at] (linear-st1) {$s_{t+1}$};
\node[agent, right=7mm of linear-st1] (linear-pit1) {$\pi_{t+1}$};
\node[action, right=7mm of linear-pit1] (linear-at1) {$a_{t+1}$};
...
\node[action] (am2) {$a_{t-2}$};
\node[state, below=7mm of am2] (sm1) {$s_{t-1}$};
\node[agent, below=7mm of sm1] (pim1) {$\pi_{t-1}$};

\node[action, right=31mm of am2] (am1) {$a_{t-1}$};
\node[state, below=7mm of am1] (st) {$s_t$};
\node[agent, below=7mm of st] (pit) {$\pi_t$};

\node[action, right=31mm of am1] (at) {$a_t$};
\node[state, below=7mm of at] (st1) {$s_{t+1}$};
\node[agent, below=7mm of st1] (pit1) {$\pi_{t+1}$};
...
\begin{scope}[on background layer]
  \node[timestep, fit=(am2)(sm1)(pim1),
        label={[text=diagramText,font=\small]above:$t-1$}] (box-m1) {};
  \node[timestep, fit=(am1)(st)(pit),
        label={[text=diagramText,font=\small]above:$t$}] (box-t) {};
  \node[timestep, fit=(at)(st1)(pit1),
        label={[text=diagramText,font=\small]above:$t+1$}] (box-p1) {};
\end{scope}
